...
public class Main {
    public static void main(String[] args) {
        PhoneFactory phoneFactory = new PhoneFactory("애풀");
        ...
        Factory factory = new Factory("애플") {
            ...
            public void produce(String model) {
                System.out.println(getName()+"잠깐 만들어진 익명클래스가 무언가를 생산합니다.");
            }
        ...
        //그러므로 추상클래스의 객체가 만들어진 것이 아니기때문에 추상클래스의 개념에 위배되는것은 아니다.

        TableFactory tableFactory = new TableFactory("apple");
